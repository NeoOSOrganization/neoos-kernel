...
struct cpu {
    ...
    // Names of the locks counted by held_depth, innermost last. Ranks
    // alone were enough to CHECK ordering but not to report it: an
    // assertion that fires with "holding=(none)" because the call site
