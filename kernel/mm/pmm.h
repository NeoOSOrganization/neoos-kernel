...
// One past the highest usable frame index: every frame pmm can ever
// hand out has an index below this. Fixed once pmm_init returns.
uint64_t pmm_frame_limit(void);
