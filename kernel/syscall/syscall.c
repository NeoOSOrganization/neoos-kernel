...
static const struct syscall_desc syscall_table[SYS_MAX] = {
    ...
    [SYS_ACCEPT4]         = { sys_accept4,         "accept4" },
    ...
    [SYS_MLOCK]           = { sys_mlock,           "mlock" },
    [SYS_SYSINFO]         = { sys_sysinfo,         "sysinfo" },
    [SYS_STATFS]          = { sys_statfs,          "statfs" },
    [SYS_GET_MEMPOLICY]   = { sys_get_mempolicy,   "get_mempolicy" },
    [SYS_MADVISE]         = { sys_madvise,         "madvise" },
    [SYS_EPOLL_CREATE1]   = { sys_epoll_create1,   "epoll_create1" },
    [SYS_EPOLL_CTL]       = { sys_epoll_ctl,       "epoll_ctl" },
    [SYS_EPOLL_WAIT]      = { sys_epoll_wait,      "epoll_wait" },
    [SYS_EPOLL_PWAIT]     = { sys_epoll_pwait,     "epoll_pwait" },
    [SYS_READLINK]        = { sys_readlink,        "readlink" },
    [SYS_INOTIFY_INIT1]     = { sys_inotify_init1,     "inotify_init1" },
    ...
    [SYS_NICE]                    = { sys_nice,                    "nice" },
    [SYS_SETPRIORITY]            = { sys_setpriority,            "setpriority" },
    [SYS_GETPRIORITY]           = { sys_getpriority,           "getpriority" },
    ...
    [SYS_SCHED_SETPARAM]        = { sys_sched_setparam,        "sched_setparam" },
    [SYS_SCHED_GETPARAM]       = { sys_sched_getparam,       "sched_getparam" },
    [SYS_SCHED_GET_PRIORITY_MAX] = { sys_sched_get_priority_max, "sched_get_priority_max" },
    [SYS_SCHED_GET_PRIORITY_MIN] = { sys_sched_get_priority_min, "sched_get_priority_min" },
    [SYS_SCHED_RR_GET_INTERVAL]  = { sys_sched_rr_get_interval,  "sched_rr_get_interval" },
    [SYS_SCHED_SETATTR]         = { sys_sched_setattr,         "sched_setattr" },
    [SYS_SCHED_GETATTR]        = { sys_sched_getattr,        "sched_getattr" },
    [SYS_SCHED_SETAFFINITY]     = { sys_sched_setaffinity,     "sched_setaffinity" },
    [SYS_EVENTFD2]        = { sys_eventfd2,        "eventfd2" },
    [SYS_PRCTL]          = { sys_prctl,           "prctl" },
    [SYS_PPOLL]          = { sys_ppoll,           "ppoll" },
    [SYS_CLOCK_NANOSLEEP] = { sys_clock_nanosleep, "clock_nanosleep" },
    [SYS_CLOSE_RANGE]    = { sys_close_range,     "close_range" },
    [SYS_STATX]          = { sys_statx,           "statx" },
