...
shell: busybox iso disk-image
	...
	@echo "NeoOS: booting to a BusyBox shell. Type in the QEMU window;"
	@echo "       'exit' powers the machine off. Serial log: $(BUILD_DIR)/shell.log"
...
shell-serial: busybox iso disk-image
	@printf '%s\n' \
